...
# -- ITERATION : FINAL WITH SPECIFIC PART NUMBER ---------------------------------------------------------------
...
#                     qty_str = f"{qty}" if (qty is not None and str(qty).strip().lower() != "nan") else ""
#                     if qty_str and km_val is not None:
#                         last_display = f"{last_date_str} ({qty_str} L – {km_val} {unit})"
#                     elif qty_str:
#                         last_display = f"{last_date_str} ({qty_str} L)"
#                     elif km_val is not None:
#                         last_display = f"{last_date_str} ({km_val} {unit})"
#                     else:
